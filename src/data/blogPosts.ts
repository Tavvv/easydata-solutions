...
export const blogPosts: BlogPost[] = [
  {
    ...
    "blocks": [
      ...
      {
        "type": "paragraph",
        "text": "At Easy Data Solutions, we have built IT infrastructure for BOI-approved factories in the EEC since 2024. Our reference project (Oracle/VMware/Windows Server environment) demonstrates what a production-ready manufacturing IT setup looks like."
      },
      {
        "type": "paragraph",
    ...
    "blocks": [
      ...
      },
      {
        ...
        "items": [
          ...
          "**Manufacturing experience:** Our reference project (Oracle/VMware/Windows Server) demonstrates production-ready IT delivery.",
  ...
  },
  {
    ...
    "blocks": [
      ...
      {
        "type": "paragraph",
        "text": "**Reference project:** Our reference project included MES integration with Oracle database, VMware virtualization, and parent-company ERP connectivity. The system has been operational since 2024 with 99.8% uptime."
      },
      {
        "type": "paragraph",
